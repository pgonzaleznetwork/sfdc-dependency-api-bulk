function format(metadata){
    ...
    function datatable(){
        ...
        source.columns = [
            ...
            {field:'metadataUsedId',header:'Id'}
        ]
        ...
        source.data = mtds.map(md => {
            ...
            md.metadataUsedId = md.hasReferenceTo.id;
    ...
    function sheetFormat(metadata,format){
        ...
        let headers = ['Name','Metadata Type','Id','Uses','Metadata Type','Id'];
        ...
        metadata.forEach(dep => {
            ...
            parts.push(`"${dep.hasReferenceTo.id}"`);
